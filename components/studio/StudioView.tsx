            ...
            <div className="flex-shrink-0 flex flex-col gap-3 animate-fade-in">
                ...
                <div className="h-32 bg-zinc-900/60 backdrop-blur-xl rounded-lg border border-white/10 p-3 flex items-center gap-3 overflow-x-auto model-filter-scrollbar">
                    ...
                    {generatedVideoUrl && videoSourceImage && (
                        <div 
                            className={`relative group h-full aspect-[3/4] rounded-md cursor-pointer transition-all duration-200 overflow-hidden flex-shrink-0 ${activeImageIndex === null ? 'ring-2 ring-offset-2 ring-violet-500 ring-offset-zinc-925 shadow-lg shadow-violet-700/30' : 'hover:opacity-80'}`}
