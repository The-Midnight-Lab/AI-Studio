...
export const PRODUCT_ANIMATION_STYLES_LIBRARY: Animation[] = [
  { id: 'pan1', name: 'Slow 360° Spin', description: 'a slow, seamless 360-degree turntable rotation.' },
  { id: 'pan2', name: 'Light Sweep', description: 'a soft light sweeps across the product surface to highlight its material.' },
  { id: 'pan3', name: 'Gentle Float', description: 'the product is gently floating and rotating slightly in place.' },
  { id: 'pan4', name: 'Cinematic Pan', description: 'a slow camera pan from left to right across the staged product.' },
];
